...
import { checkUserShipmentPermission } from '../middlewares/shipment'
...
router.post('/update', checkUserShipmentPermission, shipment.update)

router.post('/update/add-user', shipment.addUsers)

router.post('/update/remove-user', shipment.removeUsers)

router.delete('/:id', queryParams.verifyIdParam, checkUserShipmentPermission, shipment.remove)
