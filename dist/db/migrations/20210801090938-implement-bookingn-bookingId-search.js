...
module.exports = {
    up: (queryInterface, Sequelize) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            yield queryInterface.sequelize.query(`UPDATE ${table} SET ${vectorName} = to_tsvector("bookingId");`, { transaction });
        ...
        FOR EACH ROW EXECUTE PROCEDURE tsvector_update_trigger(${vectorName}, 'pg_catalog.simple', "bookingId");
      `, { transaction });
